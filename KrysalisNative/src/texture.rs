...
pub fn main() -> Result<(), Box<dyn Error>> {
    unsafe {
        ...
        let image = image::load_from_memory(include_bytes!("../../assets/textures/rust.png"))
            .unwrap()
            .to_rgba8();
        ...
        let mut vertex_spv_file = Cursor::new(&include_bytes!("../../assets/materials/texture/vert.spv")[..]);
        let mut frag_spv_file = Cursor::new(&include_bytes!("../../assets/materials/texture/frag.spv")[..]);
